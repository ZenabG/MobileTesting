# Task 1 : Exploratory Testing Session of the Monefy app
...
### Task Focus Areas:
Transaction Input, Category selection, mode of payment, editing transaction and deleting transaction.
...
### Objective:
Assess user interface for intuitiveness and ease of use.

### Task Focus Areas:
Navigation between screens, Responsiveness of touch inputs, Clarity of icons and labels, Accessibility features
...
### Objective:
Examine the app's security features and privacy settings.

### Task Focus Areas:
Password protection, Data encryption, Privacy policy compliance
